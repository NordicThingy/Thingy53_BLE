...
Il facilite la réception des données via Bluetooth Low Energy (BLE). Grâce à ce code, vous pouvez facilement interagir avec les capteurs et les services fournis par le Thingy:53.
...
**Lecture en BLE:**
- Installez et ouvrez nRF connect sur téléphone
- Cliquez sur le bouton Scan pour rechercher les appareils BLE à proximité.
- Cliquez sur le bouton CONNECT de l'appareil nommé Thingy:53.
